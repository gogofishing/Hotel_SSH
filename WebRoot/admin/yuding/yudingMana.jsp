			...
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				...
				<tr align='center' bgcolor="#FFFFFF">
					...
					<td bgcolor="#FFFFFF" align="center">
					   <form action="<%=path %>/admin/yuding/ruzhuAdd.jsp" name="ff" method="post">
						   <input type="button" value="删除" onclick="yudingDel(${yuding.id})"/>
						   
						   <input type="hidden" name="kefangId" value="${yuding.kefangId}"/>
						   <input type="hidden" name="kehuming" value="${yuding.kehuming}"/>
						   <input type="hidden" name="dianhua" value="${yuding.dianhua}"/>
