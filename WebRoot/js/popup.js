...
build:function(){
   ...
   //var close='<input type="img" id="dialogBoxClose" src="'+path+'dialogclose.gif" border="0" width="16" height="16" align="absmiddle" title="�ر�"/>';
   var close='<img id="dialogBoxClose" title="�ر�" src=/SmallHotel/img/dialogclose.gif  />';
